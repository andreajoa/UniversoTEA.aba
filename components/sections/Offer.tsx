    ...
    <section ref={ref} className="bg-gradient-to-b from-blue-50 to-purple-50 py-16 px-4">
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-8">
        ...
        <div className="w-full flex flex-col gap-4">
          {items.map((item, i) => (
            <motion.div key={i}
              ...
              <span className="text-gray-400 line-through text-sm font-semibold whitespace-nowrap">{item.value}</span>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div
          ...
          className="bg-white rounded-3xl p-8 shadow-xl border-2 border-cta text-center w-full">
          <p className="text-gray-400 line-through text-lg mb-1">Valor total: R$171</p>
          <p className="font-display font-black text-5xl text-cta mb-1">R$ 37</p>
